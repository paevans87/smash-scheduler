...
// STUB:     Task AddToBlacklistAsync(Guid playerId, Guid blacklistedPlayerId, BlacklistType blacklistType);
// STUB:     Task RemoveFromBlacklistAsync(Guid playerId, Guid blacklistedPlayerId);
